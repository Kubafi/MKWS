...
# Create a Reservoir for the inlet, set to a hydrogen/air mixture at a specified
# equivalence ratio

#First option
print('Set equivalence ratio for hydrogen/air mixture')
...
T1=input()
T1=float(T1)
print('Set pressure')#101325
p1=input()
p1=float(p1)
gas1.TP = T1, p1
gas1.set_equivalence_ratio(equiv_ratio1, 'H2:1.0', 'O2:0.5, N2:1.88')


#Second option
print('Now set equivalence ratio for hydrogen/oxygen')
...
p2=float(p2)
gas2.TP = T2, p2
gas2.set_equivalence_ratio(equiv_ratio2, 'H2:1.0', 'O2:0.5')
...
while combustor1.T > 1000 or combustor2.T > 1000:
